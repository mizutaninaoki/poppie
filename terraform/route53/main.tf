#---------------------------------------------------
# data (Route53に登録したpoppie.techのホストゾーンを取得)(すでに手動でroute53のホストゾーンを作成している場合）
#---------------------------------------------------
...
#--------------------------------------------------------------
# ホストゾーン作成後、お名前comで発行したドメインを使用している場合、ネームサーバーの変更が必要！
# ネームサーバー変更が反映されたかどうかは右のコマンドで確認できる（dig poppie.tech ns +short）
...
# (Route53に登録したドメイン(poppie.tech)でアクセスしてきた時、ロードバランサーに飛ぶように、Aレコードを作成)
#----------------------------------------------------------------------------------------------
